# MTS standard application x_tempalte_x
...
`CU00X` folder contains a x_tempalte_x from which any controlled unit can be scaffolded. At this moment, there is PowerShell script `Create-Controlled-Unit` located in the root of the solution directory.
